...
**참조 spec:** `docs/specs/ios/2026/2026-08-13-history-stats-design.md` (§2 탭 구조, §3 용어·집계 규칙, §5 통계 탭, §7 파일 구조, §9 테스트)

**선행 plan:** ⑤ `docs/plans/ios/2026/2026-08-13-receive-and-history.md` — **반드시 먼저 머지되어 있어야 한다.** 이 plan은 ⑤가 만든 `GolfRound.isFullRound`·`GolfRound.recordedHoleCount`·`StatCard`·`EmptyRounds`·`HistoryView`를 그대로 쓴다.
