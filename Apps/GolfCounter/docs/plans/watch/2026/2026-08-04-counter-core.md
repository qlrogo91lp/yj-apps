...
**참조 spec:** `docs/specs/shared/2026/2026-07-31-golfcounter-rebuild-design.md` (§3 카운터 규칙·RoundSnapshot, §4 워치 화면 흐름, §8 HealthKit, §11 테스트, §12 에러 처리)
...
참조: `docs/plans/watch/2026/2026-08-04-counter-core.md`
EOF
)"
```
