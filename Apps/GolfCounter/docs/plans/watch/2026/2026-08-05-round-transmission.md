...
**참조 spec:** `docs/specs/shared/2026/2026-07-31-golfcounter-rebuild-design.md` (§3 홀 수 선택·미기록 홀 트림·`RoundSnapshot`, §4 홀 수 선택 화면·종료 요약, §5 전송)

**선행 plan:** ③ `docs/plans/watch/2026/2026-08-04-counter-core.md` (PR #7 머지 완료). 이 plan은 ③이 만든 `RoundViewModel`·`RoundSnapshot`·`HomeView`·`RoundSessionView`를 **수정**한다.
...
참조: `docs/plans/watch/2026/2026-08-05-round-transmission.md`
EOF
)"
```
