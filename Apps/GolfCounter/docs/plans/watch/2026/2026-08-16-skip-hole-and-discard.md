...
**참조 spec:** `docs/specs/ios/2026/2026-08-13-history-stats-design.md` §3 (유효 홀 / 집계 대상 홀 / 기록 홀 수), `docs/specs/watch/2026/2026-08-14-round-transmission-design.md` (종료 → 요약 → 전송 플로우)
