...
**Architecture:** 스펙 `docs/specs/watch/2026/2026-08-13-folder-structure-design.md`의 §3 최종 구조를 그대로 구현한다. 페이지 폴더 5개(SessionControls·ParSelection·Counting·Scorecard·SessionMetrics)와 컨테이너 2개(RoundSessionView 가로축, ScoringView 세로축)로 정리하고, 워치 전용 어댑터는 신설 `WatchApp/Services/`로 옮긴다. 모든 변경은 git mv + 타입명 치환 + 인라인 페이지 2건 추출이다.
...
**Files:**
- Modify: `docs/specs/shared/2026/2026-07-31-golfcounter-rebuild-design.md` (§2 폴더 구조 그림)
- Modify: `docs/specs/watch/2026/2026-08-11-counter-redesign-design.md` (파일 경로 표)
...
grep -n "Counter/Components\|CounterPage\|CounterSizing\|CounterHeader" \
  docs/specs/watch/2026/2026-08-11-counter-redesign-design.md
```
...
## Summary
- 스펙: docs/specs/watch/2026/2026-08-13-folder-structure-design.md
