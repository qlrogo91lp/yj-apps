...
**참조 spec:** `docs/specs/shared/2026/2026-07-31-golfcounter-rebuild-design.md` (§3 RoundSnapshot, §7 컴플리케이션 / Smart Stack)
...
참조: `docs/plans/shared/2026/2026-08-02-complication.md`
EOF
)"
```
