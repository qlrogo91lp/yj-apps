...
**참조 spec:** `docs/specs/shared/2026/2026-08-17-localization-design.md` — 섹션 번호 참조는 전부 이 문서 기준이다.
...
| `docs/specs/shared/2026/2026-07-31-golfcounter-rebuild-design.md` (수정) | §10 형식 결정 정정 | 1 |
...
`docs/specs/shared/2026/2026-07-31-golfcounter-rebuild-design.md`에서 아래 줄을 교체한다.
...
git add ComplicationApp/ Shared/Models/ComplicationState.swift \
        ...
        docs/specs/shared/2026/2026-07-31-golfcounter-rebuild-design.md
