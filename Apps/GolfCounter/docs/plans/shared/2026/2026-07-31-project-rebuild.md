...
**참조 spec:** `docs/specs/shared/2026/2026-07-31-golfcounter-rebuild-design.md` (§2 프로젝트 구조, §3 데이터 모델)
...
`docs/specs/`(설계)·`plans/`(구현 계획, 파일명에 common-/watch-/ios- prefix). 사용자 검토 전에는 커밋하지 않는다.
```
