...
**Spec:**
- `Apps/HaruchiFit/docs/specs/shared/2026/2026-09-02-haruchi-fit-product-spec.md` — 무엇을 만들지
- `Apps/HaruchiFit/docs/specs/shared/2026/2026-09-02-haruchi-fit-architecture.md` — 어떻게 만들지 (결정 사항은 6절 D-M1~D-M7)
...
echo "docs/plans/x.md" | grep -vE '(^|/)docs/|\.md$' || echo "문서만 — 스킵 (정상)"
...
- Modify: `Apps/HaruchiFit/docs/specs/shared/2026/2026-09-02-haruchi-fit-architecture.md` — 2절·3절에 결과 반영
...
`Apps/HaruchiFit/docs/specs/shared/2026/2026-09-02-haruchi-fit-architecture.md`를 고친다.
