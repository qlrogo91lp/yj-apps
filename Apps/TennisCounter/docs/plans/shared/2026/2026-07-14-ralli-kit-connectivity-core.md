...
**연관 문서:** `docs/ideas/workout-kit-spm-feasibility.md`(설계 확정본), `docs/plans/shared/2026/2026-07-13-ralli-kit-workout-core.md`(Plan 1 — 실행 기록의 교훈 반영: Release 빌드 검증, watch destination id). 후속 Plan 3 = PersistenceCore.
