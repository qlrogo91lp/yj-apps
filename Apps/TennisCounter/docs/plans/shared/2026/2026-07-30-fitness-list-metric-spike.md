...
**연관 문서:** `docs/specs/shared/2026/2026-07-30-post-persistence-app-improvements-design.md` (③ 절)

## Global Constraints

- **선행 조건**: `docs/plans/shared/2026/2026-07-30-total-calories.md`(① 총 칼로리)를 **먼저 완료하고 실기기 검증까지 마친 뒤** 착수한다. basal 샘플이 워크아웃에 붙는지 여부가 이 조사의 핵심 실험 변수 중 하나다.
- **알려진 사실 (재조사 금지)**:
...
| `docs/logs/2026-07-30-fitness-list-metric-spike.md` | 관찰 기록과 결론 — **이 계획의 진짜 산출물** | 2, 3, 4 |
...
```swift
    ...
    /// **조사가 끝나면 이 파일을 삭제한다** (docs/plans/shared/2026/2026-07-30-fitness-list-metric-spike.md Task 4).
...
- Produces: `docs/logs/2026-07-30-fitness-list-metric-spike.md`에 기록된 두 워크아웃의 덤프 비교표. Task 3이 이를 근거로 가설을 검증한다.
...
`docs/logs/2026-07-30-fitness-list-metric-spike.md`를 다음 뼈대로 생성하고 채운다:
...
- Modify: `docs/logs/2026-07-30-fitness-list-metric-spike.md` (결론)
...
cd /Users/yj/Workspace/tennis_counter
make fix && make lint
git add iOSApp docs/logs/2026-07-30-fitness-list-metric-spike.md
...
1. `docs/logs/2026-07-30-fitness-list-metric-spike.md`에 **두 워크아웃의 덤프 비교표가 채워져 있고**, "결론" 절이 "해결" 또는 "수정 불가" 중 하나로 명확히 적혀 있다
