...
**연관 문서:** `docs/ideas/workout-kit-spm-feasibility.md`(설계 확정본 — PersistenceCore 절), `docs/plans/shared/2026/2026-07-13-ralli-kit-workout-core.md`(Plan 1), `docs/plans/shared/2026/2026-07-14-ralli-kit-connectivity-core.md`(Plan 2), `docs/logs/2026/2026-07-16-rallikit-spm-extraction-status.md`(진행 현황 — 이 계획이 갱신 대상).
...
- Modify: `docs/logs/2026/2026-07-16-rallikit-spm-extraction-status.md` (product 표, Plan 3 절, 레포 경로, 릴리즈 체크리스트)
...
`docs/logs/2026/2026-07-16-rallikit-spm-extraction-status.md`를 다음 4곳 수정한다.
...
- 계획: `docs/plans/shared/2026/2026-07-30-ralli-kit-persistence-core.md`
...
```bash
cd /Users/yj/Workspace/tennis_counter
git add CLAUDE.md docs/logs/2026/2026-07-16-rallikit-spm-extraction-status.md
...
체크리스트는 Task 4에서 갱신한 `docs/logs/2026/2026-07-16-rallikit-spm-extraction-status.md`의 "⚠️ 남은 작업" 절을 단일 출처로 쓴다 (Plan 1 3항목 + Plan 2 7항목 + Plan 3 4항목).
