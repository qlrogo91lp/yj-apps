...
- **선행 조건**: `docs/plans/shared/2026/2026-07-30-ralli-kit-persistence-core.md`(Plan 3)가 완료된 상태에서 착수한다.
...
전부 통과하면 `docs/logs/2026-07-30-match-wide-undo.md`에 결과를 남긴다. 실패가 있으면 증상을 기록하고 `superpowers:systematic-debugging`으로 진입한다. 롤백 단위는 Task 2(iOS 커밋)·Task 3(Watch 커밋)으로 분리돼 있어 한쪽만 되돌릴 수 있다.
