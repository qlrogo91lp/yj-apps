...
- **선행 조건**: `docs/plans/shared/2026/2026-07-30-ralli-kit-persistence-core.md`(Plan 3) 완료. `docs/plans/shared/2026/2026-07-30-match-wide-undo.md`(② undo)는 파일이 겹치지 않으므로 순서 의존은 없다.
...
결과를 `docs/logs/2026-07-30-total-calories.md`에 남긴다 — 특히 basal 수집 여부와 실제 활동:총 비율(예: 활동 320 / 총 415)을 적어 둔다. 이 값은 피트니스 목록 지표 스파이크의 실험 변수이기도 하다.
