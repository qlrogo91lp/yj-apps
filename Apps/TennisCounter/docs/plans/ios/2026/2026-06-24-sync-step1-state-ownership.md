...
**범위 메모:** 이 plan은 spec(`docs/specs/ios/2026-06-24-sync-authority-redesign-design.md`)의 구현 순서 1단계만 다룬다. driver/mirror 단방향(2단계), workoutEnd 가드·미러 UI(3단계), 저장 upsert(4단계)는 별도 plan.
