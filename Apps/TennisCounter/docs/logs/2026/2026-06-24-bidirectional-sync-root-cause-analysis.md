...
>
> **후속 산출물:**
> - 설계: `docs/specs/ios/2026-06-24-sync-authority-redesign-design.md` (커밋 1dd043f)
> - 계획: `docs/plans/ios/2026-06-24-sync-step1~4-*.md` (커밋 0d04214)
...
**계획:** `docs/plans/ios/2026-06-24-sync-step1-state-ownership.md`
...
**계획:** `docs/plans/ios/2026-06-24-sync-step2-unidirectional-authority.md`
...
**계획:** `docs/plans/ios/2026-06-24-sync-step3-workoutend-guard-mirror-ui.md`
...
**계획:** `docs/plans/ios/2026-06-24-sync-step4-save-upsert.md`
