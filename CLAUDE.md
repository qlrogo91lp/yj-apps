...
├─ TODO.md               진행 중인 작업의 문서 링크와 상태. 오랜만에 돌아오면 여기부터
...
- **루트 `TODO.md` 는 진행 중인 작업의 링크·상태만 담는다.** 스펙·플랜을 추가하거나 항목을 끝내면
  **같은 커밋에서** 갱신한다 (끝난 행은 `~~취소선~~`). 출시 커밋에서 취소선 행을 비운다.
  내용은 여기 적지 않는다 — 스펙·플랜이 갖는다.
