...
2026-09-07 상태 점검 기준. 순서 합의: **1 → 5 → 3 → 7**, 나머지는 항목별 브레인스토밍.
...
| 4 | 크라운 — 점수 수정 UX | 논의 필요 — iOS/워치 어느 쪽인지부터 | 참고: [iOS ScoreEditSheet](Apps/TennisCounter/iOSApp/Features/Match/Score/Components/ScoreEditSheet.swift) · [워치 ScoreView](Apps/TennisCounter/WatchApp/Features/Match/Score/ScoreView.swift) |
| 6 | 온보딩 3~4페이지 | 논의 필요 — 항목·트리거 | — |
