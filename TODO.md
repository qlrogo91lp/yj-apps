...
| # | 항목 | 상태 | 문서 |
|---|---|---|---|
| W2 | 종료 후 요약 화면 (저장 / 버리기) | **구현 완료** · 실기기 검증 대기 — 브랜치 `feat/w2-summary` | [플랜](Apps/HaruchiFit/docs/plans/watch/2026/2026-09-07-haruchi-fit-w2-summary.md) |
...
- [ ] W2 PR → 머지 후 로드맵 "완료된 것" 표에 PR 번호 채우기 + 이 행 취소선
